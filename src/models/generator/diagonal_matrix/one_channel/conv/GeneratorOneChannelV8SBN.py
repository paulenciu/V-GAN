...
class GeneratorOneChannelV8SBN(AbstractGenerator):
    ...
    def sample_subspace_masks(self, noise, mode="train"):
        ...
        gaussian_threshold =  torch.rand(1).to("cuda" if torch.cuda.is_available() else "mps" if torch.backends.mps.is_available() else "cpu")
